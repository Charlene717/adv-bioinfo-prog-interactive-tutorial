/* Advanced Bioinformatics Programming Quiz · i18n
 * Same logic as ../i18n.js:
 * - localStorage key 'advprog_quiz_lang' (separate from tutorial lang to allow independent control)
 * - data-lang block toggle, data-zh/data-en textContent swap
 * - dispatches 'langchange' CustomEvent so dynamic rendering (renderQuiz) can re-render
 */
(function(){
  ...
  const STR = {
    appTitle:        { zh:"⚙️ 生醫資訊程式設計 (進階) 互動考題", en:"⚙️ Advanced Bioinformatics Programming Quiz" },
    ...
    rangeAll:        { zh:"全部 20 個科目", en:"All 20 subjects" },
    ...
    quizAllChapters: { zh:"生醫資訊程式設計 (進階) 互動考題（全部科目）", en:"Advanced Bioinformatics Programming Quiz (All Subjects)" },
    quizErrataTitle: { zh:"生醫資訊程式設計 (進階) 互動考題", en:"Advanced Bioinformatics Programming Quiz" },
